...
class Solver(object):
    ...
    def build_model(self):
        if self.model_name=="UNet":
            ...
            self.model = ConvTransformer(enc_in=self.input_c, c_out=self.output_c, e_layers=self.e_layers, d_channel=self.d_channel, d_model=self.d_model, n_heads=self.n_heads, d_ff=self.d_ff, dropout=self.dropout)
